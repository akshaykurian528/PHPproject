...
$id=intval($_GET['id']);
$sql="select * from examduty where id='$id'";
  ...
  <div class="content-wrapper">
   ...
   <table width="55%" border="3" align="center">
     <tr>
       ...
       <input type="text" name="dobtxt" id="dobtxt" value="<?php echo $data['Date'];?>" /></td>
     </tr>
     <tr>
     ...
     <tr>
       ...
       <td style="background-color:#FF9900"><label for="time"></label>
       <input type="time" name="appt" id="appt" value="<?php echo $data['Time_End'];?>" /></td>
     </tr>
     <tr>
       <td style="background-color:#FF9900""text-align:center">Staff Name</td>
       <td style="background-color:#FF9900"><label for="txtstaff"></label>
       <input type="text" name="txtstaff" id="txtstaff" value="<?php echo $data['Staffname'];?>" /></td>
     </tr>
	 <tr>
       <td style="background-color:#FF9900""text-align:center">Hall Name</td>
       <td style="background-color:#FF9900"><label for="txthall"></label>
       <input type="text" name="txthall" id="txthall" value="<?php echo $data['Hallname'];?>" /></td>
     </tr>
	 <tr>
       <td align="center"><input type="submit" name="btnupdate" id="btnupdate" value="Update" /></td>
       <td>&nbsp;</td>
     </tr>
   </table>   
</form>
...
$hallname=$_POST['txthall'];
$sql="update examduty set Date='$date',Time_Start='$appts',Time_End='$appt',Staffname='$staffname',Hallname='$hallname' where id='$id'";
