...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Hall Allocation</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:left">Hall Name :</th>
...
<tr>
<th style="background-color:#FF9900""text-align:left">Total no of students :</th>
<td style="background-color:#FF9900">
<select name="lsthid" id="lsthid">
          <option value="0">select</option>
        <?php
		...
		{
		?>
	 <option value=<?php echo $data["noofstudents"] ?>><?php echo $data["noofstudents"];?> </option>
	 <?php
		} 
		?>  
  </select>
...
$Hid=$_POST["lstHid"];
$hid=$_POST["lsthid"];
$sql="INSERT INTO selectedhalls(id,Hallname,noofstudents)VALUES('','$Hid','$hid')";
$query=mysqli_query($conn,$sql);
if($query)
{
