...
<tr>
<th style="background-color:#FF9900""text-align:left">sem:</th>
<td style="background-color:#FF9900"><input type="text" id="appt" name="sem"></td>
</tr>
<tr>
...
$Hid=$_POST["lstHid"];
$sem=$_POST["sem"];
$sql="INSERT INTO student_visibility(course_title,date,time_start,time_end,room,sem)VALUES('$Sid','$Date','$appts','$appt','$Hid','$sem')";
$query=mysqli_query($conn,$sql);
if($query)
{
