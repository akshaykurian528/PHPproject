    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" action="">
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Staff Allocation</font></h1>
			  <hr>
...
<td style="background-color:#FF9900"><input type="time" id="appt" name="appts"></td>
</tr>
<tr>
...
<tr>
<th style="background-color:#FF9900""text-align:left">Staff Name :</th>
...
$Sid=$_POST["lstSid"];
$Hid=$_POST["lstHid"];
$sql="INSERT INTO examduty(id,Date,time_start,time_end,Staffname,Hallname)VALUES('','$Date','$appts','$appt','$Sid','$Hid')";
$query=mysqli_query($conn,$sql);
if($query)
{
