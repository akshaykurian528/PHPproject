...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Hall Registration</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:left">Hall :</th>
<td style="background-color:#FF9900"><input type="text" name="txthall" required></td>
</tr>
<tr>
...
$sql="INSERT INTO hall(Hid,Hname,noofstudents)VALUES('','$Hname','$noofstudents')";
