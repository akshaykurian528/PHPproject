...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Subject Registration</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:left">Subject :</th>
<td style="background-color:#FF9900"><input type="text" name="txtsubject" required></td>
</tr>
<tr>
...
{
$Sname=$_POST["txtsubject"];
$sql="INSERT INTO subject(Sid,Sname)VALUES('','$Sname')";
