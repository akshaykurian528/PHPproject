...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Exam Schedule</font></h1>
			  <hr>
			  <?php
...
<td>".$data['Hallname']."</td>
<td><a href='update.php?id= $a'>Update</a></td>
<td><a href='delete.php?id= $a'>Delete</a></td>
</tr>";
}
echo "</table>";
}
