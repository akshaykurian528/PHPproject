<?php
include 'connect.php';
mysqli_select_db($conn,"exammanagement");
$id=intval($_GET['id']);
$sql="select * from student_visibility where id='$id'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <table width="55%" border="3" align="center">
     <tr>
       <td style="background-color:#FF9900""text-align:center">Sem</td>
       <td style="background-color:#FF9900"><label for="sem"></label>
       <input type="text" name="sem" id="appt" value="<?php echo $data['sem'];?>" /></td>
     </tr>
     <tr>
       <td style="background-color:#FF9900""text-align:center">Course_Title</td>
       <td style="background-color:#FF9900"><label for="date"></label>
       <input type="text" name="txtCourse_title" id="txtCourse_title" value="<?php echo $data['course_title'];?>" /></td>
     </tr>
	 <tr>
       <td style="background-color:#FF9900""text-align:center">Date</td>
       <td style="background-color:#FF9900"><label for="dobtxt"></label>
       <input type="date" name="dobtxt" id="dobtxt" value="<?php echo $data['date'];?>" /></td>
     </tr>
     <tr>
       <td style="background-color:#FF9900""text-align:center">Time_Start</td>
       <td style="background-color:#FF9900"><label for="time"></label>
       <input type="time" name="appts" id="appt" value="<?php echo $data['time_start'];?>" /></td>
     </tr>
     <tr>
       <td style="background-color:#FF9900""text-align:center">Time_End</td>
       <td style="background-color:#FF9900"><label for="time"></label>
       <input type="time" name="end" id="appt" value="<?php echo $data['time_end'];?>" /></td>
     </tr>
     <tr>
       <td style="background-color:#FF9900""text-align:center">Room</td>
       <td style="background-color:#FF9900"><label for="txt"></label>
       <input type="text" name="txt" id="txt" value="<?php echo $data['room'];?>" /></td>
     </tr>
	  <tr>
       <td align="center"><input type="submit" name="btnupdat" id="btnupdate" value="Update" /></td>
       <td>&nbsp;</td>
     </tr>
   </table>   
</form>
 ...
 <?php
if (isset($_POST['btnupdat']))
{
$sem=$_POST['sem'];
$Course_title=$_POST["txtCourse_title"];
$Date=$_POST["dobtxt"];
$appts=$_POST["appts"];
$appt=$_POST["end"];
$room=$_POST["txt"];
$sql="update student_visibility set sem='$sem',course_title='$Course_title',date='$Date',time_start='$appts',time_end='$appt',room='$room' where id='$id'";
