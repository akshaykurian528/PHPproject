...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="department Reg.php" class="nav-link ">
                  
                  <p>Department Registration</p>
                </a>			 
			 </li>
              <li class="nav-item">
                <a href="batch Reg.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="exam Reg.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="hall Allocate.php" class="nav-link ">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Exam Registration</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:left">Exam :</th>
<td style="background-color:#FF9900"><input type="text" name="txtexam" required></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Total no of students :</th>
<td style="background-color:#FF9900"><input type="number" name="txtnumber" required></td>
</tr>
<tr>
...
{
$Ename=$_POST["txtexam"];
$noofstudents=$_POST["txtnumber"];
$sql="INSERT INTO exam(id,Ename,noofstudents)VALUES('','$Ename','$noofstudents')";
