...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Staff Registration</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:center">Name :</th>
<td style="background-color:#FF9900"><input type="text" name="txtstaff" required></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Username :</th>
<td style="background-color:#FF9900"><input type="text" name="txtusername" required></td>
</tr>
<tr>
...
$sql="INSERT INTO staff(id,name)VALUES('','$username')";
$sql1="INSERT INTO login(id,Username,password,type)VALUES('','$username','$password',2)";
