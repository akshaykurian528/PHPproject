...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
          <form method="post" >
			  <h1 style="text-align:center"><font face="Times New Roman, Times, serif">Student Registration</font></h1>
			  <hr>
<table align="center"  cellpadding="30px" cellspacing="10px" border="3px">
<tr>
<th style="background-color:#FF9900""text-align:center">UPRN :</th>
<td style="background-color:#FF9900"><input type="text" name="txtuprn" ></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Semester :</th>
<td style="background-color:#FF9900"><input type="text" name="txtsem" placeholder=
"numeric value(eg:1 2 3)" ></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Student Name :</th>
<td style="background-color:#FF9900"><input type="text" name="txtstudent" required></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Email :</th>
<td style="background-color:#FF9900"><input type="email" name="txtemail" required></td>
</tr>
<tr>
<th style="background-color:#FF9900""text-align:center">Password :</th>
<td style="background-color:#FF9900"><input type="password" name="txtpassword"  required></td>
</tr>
<tr>
<td align="center" background-color="blue" colspan="2"><input type="submit"  value="   ADD   " name="btnsave"></td>
</tr>
...
$sql="INSERT INTO student(name,email,UPRN,password,sem)VALUES('$name','$email','$uprn','$password','$semester')";
$sql1="INSERT INTO student_visibility(UPRN,sem)VALUES('$uprn','$semester')";
